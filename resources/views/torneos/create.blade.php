        ...
        <form method="POST" action="{{ route('torneos.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @error('banner')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                <small class="form-hint">Imagen destacada del torneo. Formatos: JPG, PNG, GIF, WebP. Máx: 10MB</small>
            </div>
                ...
                <div class="prizes-form-container">
                    ...
                    <div id="prizesContainer">
                        @php
                            ...
                            $oldPrizes = old('prizes', $defaultPrizes);
                        @endphp
                        @foreach($oldPrizes as $index => $prize)
...
@push('scripts')
<script>
    let prizeIndex = {{ count($oldPrizes ?? $defaultPrizes) }};
    const medals = ['🥇', '🥈', '🥉', '🏅', '🏅', '🏅', '🏅', '🏅', '🏅', '🏅'];
